...
export declare type ValidationResult = true | string | AttributesValidationErrors | (string | AttributesValidationErrors)[];
export declare type ValidationResultError = string | AttributesValidationErrors;
export declare type ValidationResultErrorFinalResult = ValidationResultError | ValidationResultError[];
