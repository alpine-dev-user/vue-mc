...
declare abstract class Base {
     ...
     */
    request(config: AxiosRequestConfig | (() => AxiosRequestConfig), onRequest: OnRequestCallback, onSuccess: RequestSuccessCallback, onFailure: RequestFailureCallback): Promise<Response | null>;
...
export declare type Routes = Record<'fetch' | 'save' | 'delete' | string, string>;
export declare type Listener = (context: Record<string, any>) => void;
export declare type RouteResolver = (route: string, parameters: Record<string, string>) => string;
export declare type RequestFailureCallback = (error: any, response: Response | undefined) => void;
export declare type RequestSuccessCallback = (response: Response | null) => void;
export declare type OnRequestCallback = () => Promise<number | boolean>;
export declare type HttpMethods = 'GET' | 'POST' | 'PATCH' | 'PUT' | 'DELETE' | string;
export declare type RequestType = 'fetch' | 'save' | 'update' | 'create' | 'patch' | 'delete' | string;
